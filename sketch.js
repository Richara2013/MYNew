...
function preload(){
  ...
  blackHeart= loadImage("Images/black-heart.png");
  resetImage= loadImage("Images/reseet.png");
  destroyTarget = loadSound("Sounds/bullet target.wav");
  Shot = loadSound("Sounds/bullet-shot.mp3");
  gameOverSound = loadSound("Sounds/gameOver.wav");
  blackH = loadSound("Sounds/oneHeart gone.wav");
  invisibleT = loadSound("Sounds/targetTouches invisible.wav");
}
